...
public class Account {
	//Class Variables
		...
		void showMenu() {
			...
			System.out.println("Welcome " + customerName + ", to Central Bank !");
			...
			do {
				...
				default:
					System.out.println("Error: invalid option. Please enter valid options");
					break;
				}
			} while(option != 'F');
			System.out.println("Thank you for banking with Central Bank!");
		}
